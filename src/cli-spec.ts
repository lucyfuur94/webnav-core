...
export const DEV_COMMANDS: CommandSpec[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      { name: '--host', takesValue: true, description: 'Auto-include EVERY recorded session for this host (e.g. app.example.com) — drafts the whole site from all its drives at once.' },
    ...
    example: 'webnav dev graph-analyse --host app.example.com --draft   # or: --session a --session b',
  },
  {
    name: 'graph-edit',
